...
export function SkillPage() {
  return (
    <main>
      ...
      <Container ><CardGrid className='grid-xs2-lg4' data={skills.process} title='Design Process'></CardGrid></Container>
      <Container ><CardGrid className='grid-xs2-lg4' data={skills.achievements} title='Erfolge & Meilensteine'></CardGrid></Container>
